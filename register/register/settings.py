...
SECRET_KEY = 'django-insecure-o+!(4=9*qt(54&*8(1jc=ttfzaahbgqu@yiobn@-4+i&9659ke'
...
JWT_AUTH = {
    'JWT_RESPONSE_PAYLOAD_HANDLER': 'registeration.utils.jwt_response_payload_handler',
}
